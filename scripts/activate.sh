export GIT_USER_NAME="Hello12345678890"
export GIT_USER_EMAIL="haminp.sd@gmail.com"
...
add_to_rc "git config --global user.name Hello12345678890"
add_to_rc "git config --global user.email haminp.sd@gmail.com"
